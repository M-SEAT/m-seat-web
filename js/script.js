...
const translations = {
  hr: {
    ...
    "pricing.title": "M-SEAT paket",
    "pricing.copy": "Jednokratni pristup za izradu vlastitog projekta: gosti, stolovi, tlocrt sale i ispisi.",
    "pricing.try": "Isprobaj aplikaciju",
    "pricing.note": "Jednokratno plaćanje.",
    "pricing.featureProject": "Vlastiti projekt i pristup za rad",
    "pricing.featureExports": "PDF, Word i Excel ispisi",
    "pricing.featureVenue": "Tlocrt sale i raspored stolova",
    "pricing.includes": "Paket uključuje",
    "pricing.planOneProject": "Plan sjedenja za jedan projekt",
    "pricing.flowGuests": "Gosti",
    "pricing.flowTables": "Stolovi",
    "pricing.flowVenue": "Tlocrt sale",
    "pricing.flowExports": "Ispisi",
  ...
  en: {
    ...
    "pricing.title": "M-SEAT package",
    "pricing.copy": "One-time access for creating your own project: guests, tables, venue layout and exports.",
    "pricing.try": "Try the app",
    "pricing.note": "One-time payment.",
    "pricing.featureProject": "Your own project and work access",
    "pricing.featureExports": "PDF, Word and Excel exports",
    "pricing.featureVenue": "Venue layout and table arrangement",
    "pricing.includes": "Package includes",
    "pricing.planOneProject": "Seating plan for one project",
    "pricing.flowGuests": "Guests",
    "pricing.flowTables": "Tables",
    "pricing.flowVenue": "Venue layout",
    "pricing.flowExports": "Exports",
  ...
  de: {
    ...
    "pricing.title": "M-SEAT Paket",
    "pricing.copy": "Einmaliger Zugang für ein eigenes Projekt: Gäste, Tische, Saalplan und Exporte.",
    "pricing.try": "App testen",
    "pricing.note": "Einmalige Zahlung.",
    "pricing.featureProject": "Eigenes Projekt und Arbeitszugang",
    "pricing.featureExports": "PDF-, Word- und Excel-Exporte",
    "pricing.featureVenue": "Saalplan und Tischanordnung",
    "pricing.includes": "Paket enthält",
    "pricing.planOneProject": "Sitzplan für ein Projekt",
    "pricing.flowGuests": "Gäste",
    "pricing.flowTables": "Tische",
    "pricing.flowVenue": "Saalplan",
    "pricing.flowExports": "Exporte",
    "contact.eyebrow": "Kontakt",
